...
if __name__ == '__main__':
    ...
    create_deed_entry(6, 5, "Pick Up Some Litter", "Beautify Earth one step at a time. Even better if you can recycle.", "pieces of garbage")
    ...
    create_deed_entry(10, 15, "Mentor a Collegue/Classmate", "Tutor a classmate, or teach a coworker a neat new trick. Knowledge is power!", "hours")
    ...
    create_deed_entry(15, 30, "Give to Someone in Need", "Give a homeless person a few dollars, or some food. Every little bit counts.", "days made")
    ...
    create_deed_entry(22, 200, "Donate Blood", "The world has a blood shortage, do your part to help someone in need.", "pints of life")

    create_deed_entry(0, 0, "", "", "")
